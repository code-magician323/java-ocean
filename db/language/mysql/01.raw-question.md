...
1. 基于非唯一索引
2. 加锁的基本单位是 (next-key lock）,他是前开后闭原则
3. **在唯一索引的等值查询且值不存在时会退化为间隙锁**
...
-- name 上有普通索引
create index IDX_NAME on gaplock(name);
```
...
- 此时的区间是 (-∞, 5) (5, 10) (10, 15) (15, 20) (20, 25) (25, +supernum): 因为 Id 是唯一性主键
